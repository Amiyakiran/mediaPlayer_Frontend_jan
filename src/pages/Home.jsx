  ...
  return (
   <>
      <div className='my-5 container d-flex'>
        ...
        <Link to={'/watch-history'} style={{textDecoration:'none'}} className='ms-auto'><h5><span id='wh'>Watch History</span> <FontAwesomeIcon icon={faClockRotateLeft} className='ms-2 me-3' /></h5></Link>
